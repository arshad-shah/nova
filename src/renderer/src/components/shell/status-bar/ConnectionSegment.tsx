      ...
      >
        ...
        {isConnected && active ? (
          <>
            ...
            {driver && (
              <Box as="span" className="rounded-sm bg-chip-fill px-1 py-px text-3xs font-medium">
                {driver}
              </Box>
            )}
          </>
          ...
          <>
            ...
            <Box as="span" className="rounded-sm bg-chip-fill-subtle px-1 py-px text-3xs font-medium opacity-80">
